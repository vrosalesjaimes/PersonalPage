...
public interface PersonalProjectService {
    ...
    public ResponseEntity<PersonalProject> updatePersonalProject(Long id, PersonalProject personalProject) throws IdiomFoundException.PersonalProjectNotFoundException;
